...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_MOD_VERSION, "ro.dos.display.version");
    ...
    public void onResume() {
        ...
        Preference preference = findPreference(KEY_CM_LICENSE);
        if (preference != null) {
            getPreferenceScreen().removePreference(findPreference(KEY_CM_LICENSE));
        }
    }
