...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private void initializeAllPreferences() {
       // mServicesCategory = (PreferenceCategory) findPreference(SERVICES_CATEGORY);
		...
		mSystemsCategory.removePreference(mToggleInversionPreference);
		mSystemsCategory.removePreference(mDisplayDaltonizerPreferenceScreen);
		getPreferenceScreen().removePreference(findPreference("display_category"));
    }
	...
	//	getPreferenceScreen().removePreference(mToggleSpeakPasswordPreference);
