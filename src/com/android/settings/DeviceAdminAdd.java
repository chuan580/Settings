...
public class DeviceAdminAdd extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println("----DeviceMsgReceiver---onClick--");
    ...
    public static DeviceAdminAdd deviceAdminAdd;
    public void test(){
        System.out.println("----DeviceMsgReceiver--test-----");
   ...
   public static class DeviceMsgReceiver extends BroadcastReceiver {

        @Override
        public void onReceive(Context context, Intent intent) {
            System.out.println("----DeviceMsgReceiver--激活设备管理器广播-----");
